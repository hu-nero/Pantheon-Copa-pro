...
OBJECTS  := random.o memory.o memoryrange.o rat.o whisker.o whiskertree.o udp-socket.o traffic-generator.o remycc.o markoviancc.o estimators.o rtt-window.o ADC.o ADC_pro.o weight-moving-average.o #protobufs-default/dna.pb.o
